...
function NewPassword({isDarkMode}) {
  ...
  return (
    ...
    <div className="container p-4">
      ...
      <div className="mb-4" style={{ fontSize: "14px", color: "#6A707C" }}>
        Your new password must be unique from those previously used with min 8
        letters
      </div>

      <div className="">
        <Input size="lg" placeholder="New Password" className="mb-3" />
        <Input size="lg" placeholder="Confirm Password" className="mb-5" />
      </div>
