...
function Register({isDarkMode}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://storecode.onrender.com/api/newuser",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div style={{ backgroundColor: isDarkMode ? "#261450" : "white" }}>
      <div className="container p-4">
        ...
        <div className="d-flex align-items-center justify-content-between">
          <hr
            className="col"
            style={{ color: isDarkMode ? "gray" : "black" }}
          ></hr>
          <div
            className="col text-center"
            style={{ fontSize: "14px", color: isDarkMode ? "gray" : "black" }}
          >
            Or Register with
          </div>
          <hr
