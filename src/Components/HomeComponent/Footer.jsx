...
function Footer({isDarkMode}) {
  ...
  if (windowWidth <= 426) {
    ...
    HeadLine2.fontWeight = "200";
    HeadLine2.lineHeight = "5px";
  }
  const iconSize = {
    width: "20px",
    height: "20px",
        ...
        <div>
          ...
          <div>
            <div className="d-flex align-items-center justify-content-between gap-2 mt-4 " style={{color: isDarkMode ? "white" : "black"}}>
              ...
              <div>
                <div className="fs-6">Info</div>
              </div>
              <div>
                <div className="fs-6">Company</div>
              </div>
              <div className="">
            ...
            <div className=" d-flex align-items-center justify-content-between " style={{color: isDarkMode ? "white" : "gray"}}>
              <div>
                ...
                <p style={HeadLine2}>Dashboard</p>{" "}
              </div>
              <div>
                <p style={HeadLine2}>FAQ </p>
                <p style={HeadLine2}>Blog</p>
                <p style={HeadLine2}>Support</p>{" "}
              </div>
              <div>
                <p style={HeadLine2}>About us </p>
                <p style={HeadLine2}>Careers</p>
                <p style={HeadLine2}>Contact us </p>{" "}
              </div>
              <div>
